---
title: "Unitru Academic Backend: Clean + Hexagonal Architecture"
sidebarTitle: "Backend"
description: "Python FastAPI backend internals: Clean Architecture layers, Hexagonal ports, Playwright anti-detection, Tesseract OCR pipeline, and manual DI wiring."
---
