...
`accumulated_credits` is the sum of credits for all courses with a `final_grade` of **14 or above** (passing grade at UNT) that are not disabled. It reflects the total academic progress toward degree completion.
