...
description: "Run diagnostic and data-management scripts to inspect SUV selectors, test end-to-end extraction, download schedule catalog data, and validate the schedule optimizer."
---
...
Runs a full end-to-end test against the live SUV: authenticates with the provided credentials (retrying CAPTCHA up to 5 times), then extracts all data modules — profile, academic record, enrollment, attendance, grades, schedule, and optimized schedule options — and prints the complete JSON-like result to stdout.
