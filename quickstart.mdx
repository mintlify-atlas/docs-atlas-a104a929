---
title: "Get Unitru Academic Running Locally with Docker Compose"
sidebarTitle: "Quickstart"
description: "Clone the repo, run docker compose up --build, and open the Unitru Academic dashboard at localhost:3000 in under five minutes on any OS."
---
